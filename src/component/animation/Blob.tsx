...
const blobVariants = {
  ...
  return (
    <div className={`${className} z-0 flex items-center justify-center pointer-events-none `}>
  ...
  stroke="#FFCEAC" 
  strokeWidth="5" 
  initial={{ d: pathA }} // On force le point de départ ici
  animate={{ d: [pathA, pathB, pathA] }}
  transition={{ 
    duration: 8, 
    repeat: Infinity, 
    ease: "easeInOut",
    times: [0, 0.5, 1] // On définit les temps pour sécuriser l'interpolation
  }}
